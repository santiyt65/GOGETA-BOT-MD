/**
GOGETA-BOT@santiyt65 - _antitrabas.js
By @santiyt65 || /
**/
 ...
 // Para configurar o idioma, na raiz do projeto altere o arquivo config.json
  ...
  export async function before(m, { conn, isAdmin, isBotAdmin, usedPrefix }) {
    ...
    const fakemek = { 'key': { 'participant': '0@s.whatsapp.net', 'remoteJid': '0@s.whatsapp.net' }, 'message': { 'groupInviteMessage': { 'groupJid': '51995386439-1616969743@g.us', 'inviteCode': 'm', 'groupName': 'P', 'caption': 'Gogeta - Bot', 'jpegThumbnail': null } } };
