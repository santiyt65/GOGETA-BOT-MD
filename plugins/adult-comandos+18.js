...
const handler = async (m, {command, conn}) => {
  ...
  if (command == 'nsfwloli') {
    const res = (await axios.get(`https://github.com/santiyt65/GOGETA-BOT/blob/main/src/JSON/nsfwloli.json`)).data;
  ...
  if (command == 'randomxxx') {
    const rawjsonn = ['https://raw.githubusercontent.com/BrunoSobrino/TheMystic-Bot-MD/master/src/JSON/tetas.json', 
